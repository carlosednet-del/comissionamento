...
const ROLE_OPTIONS = [
  ...
  { value: UserRole.DIRETOR,     label: "Diretor" },
...
export function UserForm(props: Props) {
  ...
  useEffect(() => {
    if (isNonWorker) {
      ...
      form.setValue("monthlyBaseSalary" as never, null as never);
      form.setValue("monthlyCapValue" as never, null as never);
    }
